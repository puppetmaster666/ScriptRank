        ...
        <section className="comparison">
          <div className="container">
            <div className="comparison-grid">
              <div>
                <h2 style={{color: '#DC2626'}}>THE OLD WAY IS BROKEN</h2>
                <ul>
                  <li>
                    <span style={{color: '#DC2626', fontWeight: 'bold', fontSize: '24px'}}>×</span>
              ...
              <div>
                <h2 style={{color: '#059669'}}>OUR WAY: MERIT ONLY</h2>
                <ul>
                  <li>
                    <span style={{color: '#059669', fontWeight: 'bold', fontSize: '20px'}}>✓</span>
              ...
              <div className="main-leaderboard">
                <div className="leaderboard-table">
                  ...
                  {[
                    ...
                    { rank: 2, title: 'GreenEats', type: 'Business', author: 'David Park', desc: 'Zero-waste meal delivery using only reusable containers tracked by blockchain. Return containers get you discounts...', aiScore: 8.43, publicScore: 8.7, publicVotes: 18, total: 8.57 },
                    { rank: 3, title: 'Battle Royale Chess', type: 'Game', author: 'James Mitchell', desc: '100 players start on a giant chess board. Capture pieces to gain their powers. Last player standing wins...', aiScore: 8.04, publicScore: 8.3, publicVotes: 31, total: 8.17 },
                    ...
                    { rank: 5, title: 'Memory Lane VR', type: 'Game', author: 'Alex Thompson', desc: 'A VR game where players literally walk through their memories and can change small details to alter their present...', aiScore: 7.92, publicScore: 8.1, publicVotes: 15, total: 8.01 },
                    { rank: 6, title: 'AI Resume Coach', type: 'Business', author: 'Lisa Anderson', desc: 'SaaS that analyzes job postings and automatically tailors your resume to match keywords and requirements...', aiScore: 8.12, publicScore: 7.6, publicVotes: 8, total: 7.86 },
                    { rank: 7, title: 'Mind Maze VR', type: 'Game', author: 'Emily Davis', desc: 'Puzzle VR game where each level is based on psychological concepts. Solve your own mind to escape...', aiScore: 7.81, publicScore: 7.9, publicVotes: 10, total: 7.85 },
                    ...
                    { rank: 9, title: 'RentMyGarage', type: 'Business', author: 'Marcus Johnson', desc: 'Uber for storage space. Homeowners rent out garage space by the square foot, with insurance included...', aiScore: 7.63, publicScore: 7.2, publicVotes: 5, total: 7.41 },
                    { rank: 10, title: 'Echoes of Tomorrow', type: 'Movie', author: 'Jennifer Williams', desc: 'Sci-fi series about archaeologists who discover future artifacts buried in the past. Each artifact reveals humanity\'s fate...', aiScore: 8.36, publicScore: 6.8, publicVotes: 3, total: 7.58 }
                  ].map((idea) => (
